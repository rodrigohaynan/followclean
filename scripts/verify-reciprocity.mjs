...
assert.equal(candidate({})[0].classification, "review", "count alone must never trigger priority");
...
assert.equal(candidate(confirmed, "2026-09-25T08:00:00Z")[0].classification, "review", "new import invalidates old negative confirmation");
