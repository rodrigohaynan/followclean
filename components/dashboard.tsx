    ...
    <div className="space-y-6">
      <section className="flex flex-col gap-4 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Arquivo: {latest.sourceFile}</p>
        </div>
        <Link
          href="/importar"
      ...
      {comparison ? (
        ...
        <section className="rounded-[2rem] border border-blue-100 bg-blue-50 p-6 text-sm leading-6 text-blue-900">
      ...
      <section className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
        <div className="flex items-center gap-3 border-b border-slate-200 p-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Salvo apenas neste navegador.</p>
          </div>
        </div>
